...
jsonSource_reaSembradaenCaaPaneleraHa_2.addFeatures(features_reaSembradaenCaaPaneleraHa_2);var lyr_reaSembradaenCaaPaneleraHa_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaSembradaenCaaPaneleraHa_2_0.png" />  53 - 77 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHa_2_1.png" />  77 - 200 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHa_2_2.png" />  200 - 292 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHa_2_3.png" />  292 - 1567 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHa_2_4.png" />  1567 - 3286 <br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_Limite__Departamental_1.setVisible(true);lyr_reaSembradaenCaaPaneleraHa_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Limite__Departamental_1,lyr_reaSembradaenCaaPaneleraHa_2];
...
lyr_reaSembradaenCaaPaneleraHa_2.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO': 'CULTIVO', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_reaSembradaenCaaPaneleraHa_2.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_reaSembradaenCaaPaneleraHa_2.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
